// ===================================
//        components.js
// (This is a new file for UI components)
// ===================================
...
export function createCharacterCard(profile, searchName) {
    ...
    card.innerHTML = `
        ...
        <img src="assets/characters/${profile.jobName}.png" alt="${profile.jobName}" style="width:200px; height:230px; object-fit:contain; margin-bottom:12px;">
        ...
        <div style="display: flex; align-items: center; gap: 2px; margin-top: 10px;">
            <img src="${getSetIconPath(profile.setItemName ?? "")}" alt="Set Icon" style="transform: scale(0.666); padding-top:10px;">
...
export function createDetailView({ profile, equipment, setItemInfo, fameHistory, gearHistory }) {
